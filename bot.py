...
gay=['bhookye','akash bhukya','bhukya','bhookya']
...
async def on_raw_reaction_add(payload):
  ...
  if message_id == 836863235344171018:
...
async def on_message(message):
  ...
  if any(word in msg for word in gay):
    await message.add_reaction("<:rainbow_flag:836943698964381758>")
  if any(word in msg for word in funny):
    await message.add_reaction("<:kek:836949301686698004>")
  if any(word in msg for word in bruh):
    await message.add_reaction("<:ShrekO:836949826041937990>")
  if msg.startswith('hehe bwoi'):
    await message.add_reaction("<:hehebwoi:836950278619267103>")
  if any(word in msg for word in pog):
    await message.add_reaction("<:Popoga:836951051894390805>")
